let board = [
  ...
  if(board[0][0] === "x" && board[0][1] === "x" && board[0][2] === "x") {
    ...
    $('.header').css('color', 'rgb(212, 71, 255)');
  ...
  if(board[0][0] === "o" && board[0][1] === "o" && board[0][2] === "o") {
    ...
    $('.header').css('color', 'rgb(209, 69, 14)');
    $('.header').css('background', 'url(https://media2.giphy.com/media/KbADTFrN2nfF29W3AR/giphy.gif?cid=ecf05e47f1940a2447f3daee93fe097c2fd8f9ad8f6097a1&rid=giphy.gif)');
  ...
  button.addEventListener("click", function () {
    body[0].style.backgroundImage = "url('https://images.wallpapersden.com/image/download/eagle-mountain-sunset-minimalist_63668_2560x1080.jpg')" 
  });
